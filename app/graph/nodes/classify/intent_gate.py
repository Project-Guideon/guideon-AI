        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "   - If recent conversation is provided, resolve explicit pronouns and references:\n"
                    "     · Place pronouns (거기, 그곳, 그 건물, 거기서 etc.) → replace with the place name from history\n"
                    "     · Personal attributes (나는 성인/노인/어린이/가족 etc.) + cost question → add to query\n"
                    "   - Do NOT resolve or enrich beyond these two cases\n"
