        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "   - If recent conversation is provided, resolve demonstrative pronouns in ANY language:\n"
                    "     · Place/topic pronouns (ko: 거기/그곳/그것/그거, en: there/it/that, ja: そこ/それ, zh: 那里/它)\n"
                    "       → replace with the specific place/person/topic they refer to from history\n"
                    "     · Personal attributes (ko: 성인/노인/어린이, en: adult/senior/child, ja: 大人/子供 etc.)\n"
                    "       + cost question → add to query\n"
                    "   - Do NOT resolve or enrich beyond what is directly traceable to a word in the conversation\n"
                    "   - If the input is already Korean with nothing to resolve, return it as-is\n"
                    "\n"
                    ...
                    "    TOILET     : Restroom / bathroom / washroom / toilet facilities.\n"
                    "                 (e.g., 화장실, 장애인 화장실, 남녀 화장실)\n"
                    "    TICKET     : Ticket office, admission counter, entrance pass purchase point.\n"
                    "                 (e.g., 매표소, 입장권 사는 곳, 티켓 부스)\n"
                    "    RESTAURANT : Restaurant, food court — any place for a proper meal.\n"
                    "                 (e.g., 식당, 밥 먹는 곳, 음식점, 분식)\n"
                    "    SHOP       : Café, convenience store, souvenir shop, gift store — any place to buy or drink.\n"
                    "                 (e.g., 카페, 커피숍, 편의점, 기념품, 쇼핑, 뭐 살 데, 굿즈샵)\n"
                    "    INFO       : Tourist information center, help desk, general inquiry counter.\n"
                    "                 (e.g., 안내소, 인포메이션, 어디 물어보는 곳)\n"
                    "    ATTRACTION : Sightseeing spot, exhibition hall, cultural/sports/experience facility,\n"
                    "                 performance venue, photo zone — places you visit or experience.\n"
                    "                 (e.g., 전시관, 체험관, 공연장, 테니스장, 운동장, 포토존, 놀이시설)\n"
                    "    PARKING    : Car / motorcycle / bicycle parking area.\n"
                    "                 (e.g., 주차장, 차 대는 곳)\n"
                    "    OTHER      : Any facility NOT covered above — elevator, escalator, rest area,\n"
                    "                 locker, ATM, phone charging station, nursing room, smoking area,\n"
                    "                 wheelchair rental, lost & found.\n"
                    "                 (e.g., 엘리베이터, 에스컬레이터, 쉼터, 물품보관함, ATM, 충전기,\n"
                    "                        수유실, 흡연구역, 휠체어, 분실물센터)\n"
                    "                 When in doubt between OTHER and a named category, choose OTHER.\n"
                    "    (e.g., '먹을 곳/식당' → [\"RESTAURANT\", \"SHOP\"], '카페/커피/음료' → [\"SHOP\", \"RESTAURANT\"],\n"
                    "     '뭐 살 데/기념품/편의점' → [\"SHOP\", \"RESTAURANT\"], '안내소' → [\"INFO\", \"TICKET\"],\n"
                    "     '화장실' → [\"TOILET\", \"OTHER\"], '주차' → [\"PARKING\", \"OTHER\"],\n"
                    "     '테니스장/운동장/전시관' → [\"ATTRACTION\", \"OTHER\"], '흡연구역/수유실/물품보관함/ATM' → [\"OTHER\", \"TOILET\"],\n"
                    "     '엘리베이터/에스컬레이터/쉼터/충전기/휠체어' → [\"OTHER\", \"PARKING\"])\n"
