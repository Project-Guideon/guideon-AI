        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "  An ARRAY of the 1-2 MOST LIKELY categories, ordered by confidence (most likely FIRST).\n"
                    "  - Give 2 candidates when the place could plausibly fall under more than one category\n"
                    "    (e.g., '먹을 곳' → [\"RESTAURANT\", \"SHOP\"], '안내소' → [\"INFO\", \"TICKET\"]).\n"
                    "  - Give exactly 1 when you are confident (e.g., '화장실' → [\"TOILET\"]).\n"
